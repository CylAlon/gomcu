...
var Che16 = []Chinese16{
	...
	{"瀛", Arr16{
		0x12, 0x64, 0x02, 0x02, 0xEE, 0xAA, 0xAA, 0xAA, 0xAB, 0xAA, 0xAA, 0xAA, 0xEA, 0x02, 0x00, 0x00,
		0x04, 0x7E, 0x81, 0x7E, 0xAA, 0xFE, 0x84, 0x5C, 0x27, 0x5C, 0x80, 0x7E, 0x12, 0x7E, 0xE0, 0x00}},
	{"龙", Arr16{
...
//
// //go:embed chinese16.json
// var CheBuff []byte
//
// func init() {
// 	err := json.Unmarshal(CheBuff, &Che16)
// 	if err != nil {
